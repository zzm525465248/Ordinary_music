...
class HomeFragment : Fragment() {
    ...
    val list_url: MutableList<Int> = mutableListOf()
    ...
    private fun right_bt() {
       binding.apply {
           ...
           button3.setOnClickListener {
               ...
               Log.d("id",list.size.toString())
               Log.d("id",list.toString().replace("[","").replace("]",""))
               Toast.makeText(activity, "接口尚未完善，尽情期待~", Toast.LENGTH_LONG).show()
               homeViewModel.apply {
